      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <label className="block space-y-1.5">
          ...
          <select
            ...
            disabled={scanning}
            className="w-full min-h-11 rounded-xl border border-white/10 bg-black/40 px-3 py-2.5 text-base sm:text-[13px] text-gray-100 focus:outline-none focus:border-sky-500/40 disabled:opacity-60"
          >
