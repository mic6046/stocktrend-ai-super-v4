...
export function SuggestATradePanel({
  ...
  const [result, setResult] = useState<SuggestTradeResult | null>(null);
...
function SuggestedBuyZoneCard({ pick }: { pick: SuggestTradeCandidate }) {
