              ...
              >
                ...
                <div className="col-span-12 space-y-4">
                  ...
                  {/* Master Decision Feed — single recommendation + conflict brief.
                      Promoted to its own card right under the AI Score, ahead of
                      the Consensus AI panel — this is the actual verdict/reasoning,
                      so it should be visible before scrolling into anything else. */}
